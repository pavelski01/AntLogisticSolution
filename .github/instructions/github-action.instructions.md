---
description: 'Guidelines and best practices for creating and maintaining GitHub Actions'
---

## Github Action Rules

- Checki if `Direrectory.Build.props` exists in project root to summarize key MSBuild properties
